...
# url_init="http://music.taihe.com/artist/1052?pst=sug"
# driver.get(url_init)
# page_list=list(range(2,20))
# file=open("LJID_Name1.csv","w")
...
#     else:
#         songs=soup.find_all("a","namelink"+r".")
#     song=[]
#     for a in songs:
#         song_inf={}
